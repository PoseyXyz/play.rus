...
function NotFound(props) {
    return (
        <div className="h-screen w-screen relative">
            <img src={require('../images/notfound/404.png')} className="absolute z-10 h-screen w-screen"/>
            <div className="relative z-20 overlay w-screen h-screen flex flex-col justify-center items-center gap-6 text-white">
                ...
                <Link to='/'>
                <button className="bg-white text-black-v1 px-8 py-3 text-xl font-semibold hover:bg-brand-purple">Main Page</button></Link>
            </div>
        </div>
    );
}
